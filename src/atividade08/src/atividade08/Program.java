...
public class Program {
	public static void main(String args[]) {
		...
		for(int i=0; i<10; i++) {
			...
			System.out.printf("\n quantidade de itens vendidos do %d produto foi: %d\n", i+1, quantItensVendidos[i]);
		...
		System.out.printf("Valor final a ser pago ao colaborador incluindo salario e comissao:", salarioFinalVendedor);
